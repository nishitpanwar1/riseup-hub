          ...
          <div className="flex items-start gap-5 flex-wrap">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex gap-4 mt-4 text-sm font-stat">
                <Stat icon={<Users className="w-4 h-4" />} label="followers" value={profile.follower_count} />
                <Stat icon={<Eye className="w-4 h-4" />} label="total views" value={profile.total_views} />
